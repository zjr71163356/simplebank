...
const file_rpc_update_user_proto_rawDesc = "" +
	...
	"\x13password_changed_at\x18\x05 \x01(\tH\x03R\x11passwordChangedAt\x88\x01\x01B\v\n" +
	"\t_passwordB\f\n" +
	"\n" +
	"_full_nameB\b\n" +
	"\x06_emailB\x16\n" +
	"\x14_password_changed_at\"2\n" +
	"\x12UpdateUserResponse\x12\x1c\n" +
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB&Z$github.com/zjr71163356/simplebank/pbb\x06proto3"
